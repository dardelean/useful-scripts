...
sed -i '/#network_interface/i network_interface: "ens33"' /etc/kolla/globals.yml
sed -i '/#neutron_external_interface/i neutron_external_interface: "ens34"' /etc/kolla/globals.yml
